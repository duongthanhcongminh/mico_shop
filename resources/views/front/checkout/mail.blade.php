...
<head>
    ...
    <title>Order Notification | MiCoShop</title>
</head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        ...
                        <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            ...
                            <br>
                            <b>Address:</b> {{ $order->street_address . ' - ' .  $order->town_city . ' - ' . $order->country }}
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @foreach($order->orderDetails as $orderDetail)
                                <tr>
                                    <td style="border-top: 1px solid #dee2e6; padding: 5px 0;">
                                        {{ $orderDetail->product->name . ' size ' . $orderDetail->product_size . ' color ' . $orderDetail->product_color . ' (x' . $orderDetail->qty . ')'}}
                                    </td>
